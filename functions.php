...
function createNewStudentDBFile(){
  /* in this function it creates a completely different file were the information can be put.*/
...
function createStudentsTable($dbVal){
 /* this function is basically creating the table of contents or sheet where the information or data is displayed.*/ 
...
function insertNewStudentData($dbVal){
  echo "<br>";
/* This is the function that is getting your information and transferring you information.*/
...
{
/* this function is basically saying to get all theinformation and rint it all down on the sheet.*/
